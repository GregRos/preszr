...
// Node 10.4
export const _BigInt = typeof BigInt !== "undefined" ? BigInt : missingCtor<typeof BigInt>("BigInt")
...
export const _WeakRef =
    typeof WeakRef !== "undefined" ? WeakRef : missingCtor<typeof WeakRef>("WeakRef")
...
export const _MapIteratorProto = Object.getPrototypeOf(new Map()[Symbol.iterator]())
export const _SetIteratorProto = Object.getPrototypeOf(new Set()[Symbol.iterator]())
