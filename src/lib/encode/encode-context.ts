...
const TypedArray = Object.getPrototypeOf(Uint8Array.prototype).constructor as any
...
export class EncodeCtx implements EncodeContext {
    ...
    finish(selected: string) {
        ...
        wm[0] = [version, this._makeEncodingKeys(), this._encodingSpec, this._metadata, +selected]
        return wm
    }
}
