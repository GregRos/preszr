...

{
    ...
    test("self ref - structural", complexReferences, circular, preszr(items({ self: "1" })))
...

{
    ...
    test("array self ref - structural", complexReferences, circular, preszr(items(["1"])))
...

{
    ...
    test("mutually circular refs - identity", t => {
        const first = decode(encode(mutuallyCircular1)) as typeof mutuallyCircular1
