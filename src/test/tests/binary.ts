...
test(binaryOutputDeepEqual, arrayBuffer, preszr(encoded(base64, FixedIndexes.ArrayBuffer)))

function makeTypedArray(type: FixedIndexes, bufferRef: string, length: number, offset = 0) {
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.Uint16Array, "1", arrayBuffer.byteLength / 2)
    )
)
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.Uint32Array, "1", arrayBuffer.byteLength / 4)
    )
)
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.Uint8ClampedArray, "1", arrayBuffer.byteLength)
    )
)
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.BigUint64Array, "1", arrayBuffer.byteLength / 8)
    )
)
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.BigInt64Array, "1", arrayBuffer.byteLength / 8)
    )
)
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.Float32Array, "1", arrayBuffer.byteLength / 4)
    )
)
...
test(
    ...
    preszrReturnAt(
        2,
        encoded(base64, FixedIndexes.ArrayBuffer),
        makeTypedArray(FixedIndexes.Float64Array, "1", arrayBuffer.byteLength / 8)
    )
)
